...
int muuid_sha3_init(muuid_sha3_ctx_t *c, int mdlen)
{
    int i;
...
int muuid_sha3_final(void *md, muuid_sha3_ctx_t *c)
{
    int i;
...
{
    muuid_sha3_ctx_t sha3;

    muuid_sha3_init(&sha3, mdlen);
    muuid_sha3_update(&sha3, in, inlen);
    muuid_sha3_final(md, &sha3);
